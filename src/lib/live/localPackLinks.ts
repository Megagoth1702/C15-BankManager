...
export const PUBLIC_REPO = 'Megagoth1702/C15-BankManager';
...
export const RELEASES_API_LATEST =
  'https://api.github.com/repos/Megagoth1702/C15-BankManager/releases/latest';

/** GitHub Release asset name produced by `npm run pack:local`. */
export const LOCAL_PACK_ASSET_NAME = 'C15-BankManager-local.zip';
